...
graph TD
    ...
    root_TILBAKEDATERING_ETTERSENDING(ETTERSENDING) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD(BEGRUNNELSE_MIN_1_ORD) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE(FORLENGELSE) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|No| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=INVALID, ruleHit=INNTIL_8_DAGER)(TilbakedateringResult(status=INVALID, ruleHit=INNTIL_8_DAGER)):::invalid
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE(FORLENGELSE) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE(ARBEIDSGIVERPERIODE) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|No| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_ARBEIDSGIVERPERIODE_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=INNTIL_30_DAGER_MED_BEGRUNNELSE)(TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=INNTIL_30_DAGER_MED_BEGRUNNELSE)):::manuell
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|No| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_1_ORD_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=INVALID, ruleHit=INNTIL_30_DAGER)(TilbakedateringResult(status=INVALID, ruleHit=INNTIL_30_DAGER)):::invalid
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD(BEGRUNNELSE_MIN_3_ORD) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD_TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=OVER_30_DAGER_MED_BEGRUNNELSE)(TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=OVER_30_DAGER_MED_BEGRUNNELSE)):::manuell
    ...
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|Yes| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=OVER_30_DAGER_SPESIALISTHELSETJENESTEN)(TilbakedateringResult(status=MANUAL_PROCESSING, ruleHit=OVER_30_DAGER_SPESIALISTHELSETJENESTEN)):::manuell
    root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD_SPESIALISTHELSETJENESTEN(SPESIALISTHELSETJENESTEN) -->|No| root_TILBAKEDATERING_ETTERSENDING_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_INNTIL_30_DAGER_BEGRUNNELSE_MIN_3_ORD_SPESIALISTHELSETJENESTEN_TilbakedateringResult(status=INVALID, ruleHit=OVER_30_DAGER)(TilbakedateringResult(status=INVALID, ruleHit=OVER_30_DAGER)):::invalid
    root(TILBAKEDATERING) -->|No| root_TILBAKEDATERING_TilbakedateringResult(status=OK, ruleHit=null)(TilbakedateringResult(status=OK, ruleHit=null)):::ok
