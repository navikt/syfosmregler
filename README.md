...
```mermaid
graph TD
    root(UGYLDIG_ORGNR_LENGDE) -->|Yes| root_UGYLDIG_ORGNR_LENGDE_INVALID(INVALID):::invalid
    root(UGYLDIG_ORGNR_LENGDE) -->|No| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON(UGYLDIG_REGELSETTVERSJON)
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON(UGYLDIG_REGELSETTVERSJON) -->|Yes| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_INVALID(INVALID):::invalid
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON(UGYLDIG_REGELSETTVERSJON) -->|No| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39(MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39)
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39(MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39) -->|Yes| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_INVALID(INVALID):::invalid
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39(MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39) -->|No| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR(AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR)
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR(AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|Yes| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_INVALID(INVALID):::invalid
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR(AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|No| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR)
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|Yes| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR_INVALID(INVALID):::invalid
    root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR(BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR) -->|No| root_UGYLDIG_ORGNR_LENGDE_UGYLDIG_REGELSETTVERSJON_MANGLENDE_DYNAMISKE_SPOERSMAL_VERSJON2_UKE_39_AVSENDER_FNR_ER_SAMME_SOM_PASIENT_FNR_BEHANDLER_FNR_ER_SAMME_SOM_PASIENT_FNR_OK(OK):::ok
    classDef ok fill:#c3ff91,stroke:#004a00,color: black;
    classDef invalid fill:#ff7373,stroke:#ff0000,color: black;
    classDef manuell fill:#ffe24f,stroke:#ffd500,color: #473c00;
```
...
1\. ledd):::invalid
    root_BEHANDLER_GYLIDG_I_HPR_BEHANDLER_HAR_AUTORISASJON_I_HPR(BEHANDLER_HAR_AUTORISASJON_I_HPR) -->|No| root_BEHANDLER_GYLIDG_I_HPR_BEHANDLER_HAR_AUTORISASJON_I_HPR_INVALID(INVALID
1\. ledd):::invalid
    root(BEHANDLER_GYLIDG_I_HPR) -->|No| root_BEHANDLER_GYLIDG_I_HPR_INVALID(INVALID
1\. ledd):::invalid
    classDef ok fill:#c3ff91,stroke:#004a00,color: black;
    classDef invalid fill:#ff7373,stroke:#ff0000,color: black;
    classDef manuell fill:#ffe24f,stroke:#ffd500,color: #473c00;
...
graph TD
    ...
    root_HOVEDDIAGNOSE_MANGLER_FRAVAERSGRUNN_MANGLER(FRAVAERSGRUNN_MANGLER) -->|Yes| root_HOVEDDIAGNOSE_MANGLER_FRAVAERSGRUNN_MANGLER_INVALID(INVALID
1\. ledd):::invalid
    ...
    root_HOVEDDIAGNOSE_MANGLER_FRAVAERSGRUNN_MANGLER_UGYLDIG_KODEVERK_FOR_BIDIAGNOSE(UGYLDIG_KODEVERK_FOR_BIDIAGNOSE) -->|Yes| root_HOVEDDIAGNOSE_MANGLER_FRAVAERSGRUNN_MANGLER_UGYLDIG_KODEVERK_FOR_BIDIAGNOSE_INVALID(INVALID
1\. ledd):::invalid
...
1\. ledd):::ok
    ...
    root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE(UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE) -->|Yes| root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE_INVALID(INVALID
1\. ledd):::invalid
    ...
    root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE_ICPC_2_Z_DIAGNOSE(ICPC_2_Z_DIAGNOSE) -->|Yes| root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE_ICPC_2_Z_DIAGNOSE_INVALID(INVALID
1\. ledd):::invalid
    ...
    root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE_ICPC_2_Z_DIAGNOSE_UGYLDIG_KODEVERK_FOR_BIDIAGNOSE(UGYLDIG_KODEVERK_FOR_BIDIAGNOSE) -->|Yes| root_HOVEDDIAGNOSE_MANGLER_UGYLDIG_KODEVERK_FOR_HOVEDDIAGNOSE_ICPC_2_Z_DIAGNOSE_UGYLDIG_KODEVERK_FOR_BIDIAGNOSE_INVALID(INVALID
1\. ledd):::invalid
...
```mermaid
graph TD
    root(PASIENT_YNGRE_ENN_13) -->|Yes| root_PASIENT_YNGRE_ENN_13_INVALID(INVALID
1\. ledd):::invalid
...
1\. ledd 1. punktum):::ok
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE(FORLENGELSE) -->|No| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_BEGRUNNELSE_MIN_1_ORD_FORLENGELSE_INVALID(INVALID
1\. ledd 1. punktum):::invalid
...
2\. ledd 2. punktum):::ok
    ...
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_1_ORD(BEGRUNNELSE_MIN_1_ORD) -->|No| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_1_ORD_INVALID(INVALID
1\. ledd 1. punktum):::invalid
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED(TILBAKEDATERT_MINDRE_ENN_1_MAANED) -->|No| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_3_ORD(BEGRUNNELSE_MIN_3_ORD)
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_3_ORD(BEGRUNNELSE_MIN_3_ORD) -->|Yes| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_3_ORD_MANUAL_PROCESSING(MANUAL_PROCESSING
):::manuell
    root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_3_ORD(BEGRUNNELSE_MIN_3_ORD) -->|No| root_TILBAKEDATERING_SPESIALISTHELSETJENESTEN_ETTERSENDING_TILBAKEDATERT_INNTIL_4_DAGER_TILBAKEDATERT_INNTIL_8_DAGER_TILBAKEDATERT_MINDRE_ENN_1_MAANED_BEGRUNNELSE_MIN_3_ORD_INVALID(INVALID
1\. ledd 1. punktum):::invalid
