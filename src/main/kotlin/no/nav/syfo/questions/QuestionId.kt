...
enum class QuestionId(val spmId: String, val spmTekst: String, val restriksjon: RestrictionCode) {
    ...
    ID_6_4_1(
        "6.4.1", "Beskriv kort sykehistorie, symptomer og funn i dagens situasjon",
        RestrictionCode.RESTRICTED_FOR_EMPLOYER
    ),
    ID_6_4_2(
        "6.4.2", "Beskriv pågående og planlagt henvisning, utredning og/eller behandling",
        RestrictionCode.RESTRICTED_FOR_EMPLOYER
    ),
    ID_6_4_3(
    ...
    ID_6_5_1(
        "6.5.1", "Beskriv kort sykehistorie, symptomer og funn i dagens situasjon.",
        RestrictionCode.RESTRICTED_FOR_EMPLOYER
    ),
    ...
    ID_6_6_3(
        "6.6.3", "Hvilken betydning har denne sykdommen for den nedsatte arbeidsevnen?",
        RestrictionCode.RESTRICTED_FOR_EMPLOYER
    ),
}
