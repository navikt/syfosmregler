...
enum class LegesuspensjonRuleChain(override val ruleId: Int?, override val status: Status, override val predicate: (RuleData<Boolean>) -> Boolean) : Rule<RuleData<Boolean>> {
    ...
    BEHANDLER_SUSPENDED(1414, Status.INVALID, { (_, suspended) ->
        suspended
    }),
}
