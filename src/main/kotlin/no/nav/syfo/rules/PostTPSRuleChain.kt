...
enum class PostTPSRuleChain(override val ruleId: Int?, override val status: Status, override val predicate: (RuleData<TPSPerson>) -> Boolean) : Rule<RuleData<TPSPerson>> {
    ...
    PATIENT_HAS_SPERREKODE_6(1305, Status.MANUAL_PROCESSING, { (_, patient) ->
