...
internal fun RuleNode<PatientAgeOver70Rules, RuleResult>.yes(status: Status, ruleHit: PatientAgeOver70RuleHit? = null) {
    yes(RuleResult(status, ruleHit?.ruleHit))
}

internal fun RuleNode<PatientAgeOver70Rules, RuleResult>.no(status: Status, ruleHit: PatientAgeOver70RuleHit? = null) {
